...
class User extends CI_Controller
{
    ...
    public function edit()
    {
        ...
        $this->form_validation->set_rules('name', 'Full Nama', 'required|trim');
    ...
    public function changepassword()
    {
        ...
        $this->form_validation->set_rules('new_password2', 'Confirm New Password', 'requires|trim|min_length[3]matches[new_password1]');
