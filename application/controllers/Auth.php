...
class Auth extends CI_Controller
{
    ...
    {   
        ...
        if($this->form_validation->run() == false) {
            ...
            role="alert">Congratulation,your account has been creted. 
    ...
    public function changePassword()
    {
        ...
        $this->form_validation->set_rules('password2','Repeat Password','trim|required|min_length[30]|matches[password1]');
        if($this->form_validation->run() == false) {
